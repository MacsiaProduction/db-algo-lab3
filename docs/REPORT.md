...
> Краткая версия. Графики и числа те же, что в `DRAFT.md`; пояснения сведены к минимуму. Методика — `METHODOLOGY.md`.
...
- Ground truth пересчитан локально через `IndexFlatL2`, кеш `data/gt_n{n}_k100.npy`.
